...
class ParkingSlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parking_slot" do
    assert_difference('ParkingSlot.count') do
      post parking_slots_url, params: { parking_slot: { empty: @parking_slot.empty, forDisabled: @parking_slot.forDisabled, position: @parking_slot.position } }
    end
  ...
  test "should update parking_slot" do
    patch parking_slot_url(@parking_slot), params: { parking_slot: { empty: @parking_slot.empty, forDisabled: @parking_slot.forDisabled, position: @parking_slot.position } }
