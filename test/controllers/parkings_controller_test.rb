...
class ParkingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parking" do
    assert_difference('Parking.count') do
      post parkings_url, params: { parking: { NumberOfSlots: @parking.NumberOfSlots, addressNumber: @parking.addressNumber, city: @parking.city, street: @parking.street } }
    end
  ...
  test "should update parking" do
    patch parking_url(@parking), params: { parking: { NumberOfSlots: @parking.NumberOfSlots, addressNumber: @parking.addressNumber, city: @parking.city, street: @parking.street } }
